  ...
  return (
    <div className='bg-primaryLight w-full text-white flex flex-col sm:flex-row items-center justify-center sm:justify-start relative sm:h-[700px] hero-image-height'>
      <div className='hidden sm:block h-full w-full relative'>
        ...
        />
        <div className='h-full w-full absolute top-0 opacity-60 bg-gradient-to-r from-black'/>
      </div>
      ...
      <div className='absolute flex flex-col justify-center sm:justify-end items-center sm:h-[75%] w-full sm:w-1/2 h-full sm:rounded-r-lg sm:rounded-l-none sm:rounded-md sm:min-w-[650px] z-20 sm:z-0 px-3 ml-[100px]'>
        <div className='flex flex-col h-full justify-between sm:justify-center items-center sm:items-start text-primary sm:w-[650px] p-3 sm:mr-[100px] gap-8'>
          ...
          <div className='flex flex-col justify-center items-center sm:items-start w-full gap-8 h-full sm:h-auto'>
            <p className='text-[18px] sm:text-[20px] leading-6 sm:leading-8 text-white text-center sm:text-start max-w-[450px] font-bold hero-outline'>
              {heroMain.desc}
            </p>
