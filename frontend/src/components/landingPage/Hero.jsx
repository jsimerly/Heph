...
const Hero = () => {  
  ...
  return (
    <div className='bg-primaryLight w-full text-white flex flex-col sm:flex-row items-center justify-center sm:justify-start relative sm:h-[700px] hero-image-height'>
      ...
      <div className='absolute flex flex-col justify-center sm:justify-end items-center sm:h-[75%] w-full sm:w-1/2 h-full sm:bg-white sm:rounded-r-lg sm:rounded-l-none sm:rounded-md sm:min-w-[650px] z-20 sm:z-0 px-6'>
        <div className='flex flex-col h-full justify-between sm:justify-center items-center sm:items-start text-primary sm:w-[550px] p-3 sm:mr-[100px] gap-8'>
          ...
          <div className='flex flex-col justify-center items-center sm:items-start w-full gap-8 h-full'>
